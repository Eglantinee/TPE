...
while m < 4:
    ...
    norm_matrix  = [[ 10, -25,  10, 199, 224, 200],
    ...
    s_y1 = sum([(norm_matrix[0][i] - y1_abs) ** 2 for i in range(3, 6)]) / m
    s_y2 = sum([(norm_matrix[1][i] - y2_abs) ** 2 for i in range(3, 6)]) / m
    s_y3 = sum([(norm_matrix[2][i] - y3_abs) ** 2 for i in range(3, 6)]) / m
    s_y4 = sum([(norm_matrix[3][i] - y4_abs) ** 2 for i in range(3, 6)]) / m
